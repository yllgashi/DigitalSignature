...
namespace DigitalSignature {
    public partial class CreateDigitalSignForm : Form
    {
        ...
        { 
            ...
            if (file != null) textBoxSelectFile.Text = file;
        }
        ...
        private void buttonGenerateDigitalSignature_Click(object sender, EventArgs e)
        {
            if(!String.IsNullOrEmpty(textBoxSelectFile.Text))
            {
                ...
                hashBuffer = HASH.GenerateFileHASH(textBoxSelectFile.Text, comboBoxHash.SelectedItem.ToString());
        ...
        private void buttonSaveToFile_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(textBoxDigitalSignature.Text))
            {
                ...
                else MessageBox.Show("File could not be saved", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                MessageBox.Show("Please generate Digital Signature and Public Key first", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
